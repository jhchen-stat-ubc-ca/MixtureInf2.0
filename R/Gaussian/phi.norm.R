## Lost track of what this one is for

phi.norm <-
function(x, m0, lambda, inival, len, n.iter, tol)
{
#x: 		data, either a vector or a matrix with the 1st column being the observed values
...
#tol:		tolerance for the convergence of the EM-algorithm.
	if (m0>1)
	{
		sn=var(x);     dn=sd(x)
