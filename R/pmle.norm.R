...
#' @param m0 The order of finite normal mixture model
#' @param lambda The size of penalized function of mixing distribution.
...
#' @param rformat The format of the output. If rformat=T, it means the output format is determined by R software.
#		              If rformat=F, it means the output format is determined by our default setting. When the output is
